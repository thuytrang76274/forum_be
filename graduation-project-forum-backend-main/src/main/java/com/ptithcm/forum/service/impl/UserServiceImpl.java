...
public class UserServiceImpl implements UserService {
  ...
  public ResponseDto<PageDto<UserDto>> getUsers(int page, int size, String sortBy,
    ...
    Page<User> users = userRepository.getListUserExcludeAdminUser(pageable);
  ...
  private void updateForAdminUser(User currentUser, User currentLoggedInUser,
    ...
    if ((userUpdate.isUpdateUsername() || userUpdate.isUpdateStatus())
  ...
  private void updateUsernameForUser(User currentUser, UserUpdateDto userUpdate) {
    currentUser.setUsername(
        userUpdate.isUpdateUsername() ? userUpdate.getUsername() : currentUser.getUsername());
  }

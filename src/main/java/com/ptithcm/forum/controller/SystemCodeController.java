...
public class SystemCodeController {
  ...
  @GetMapping("{system-code}/system-code-detail")
  public ResponseDto<List<SystemCodeDetailDto>> getSystemCodeDetails(@PathVariable("system-code") String systemCode) {
    return systemCodeService.getSystemCodeDetails(systemCode);
  }

...
public class SystemCodeServiceImpl implements SystemCodeService {
  ...
  @Override
  public ResponseDto<List<SystemCodeDetailDto>> getSystemCodeDetails(String systemCode) {
    return new ResponseDto<>(
        systemCodeDetailRepository.getListSystemCodeDetailByCode(systemCode).stream()
            .map(systemCodeDetailMapping::convertSystemCodeDetailToSystemCodeDetailDto).toList());
  }
